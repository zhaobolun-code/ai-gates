...
- 已完成索引：`./已完成/_索引.md`
- 模块 README：
- 相关黄金场景子集：`.cursor/verify/golden-scenes.yaml`（无则写无）
...
> 策划写 Mandatory 前扫 `.cursor/lessons-outline.md` → 主表；程序员改码前只读下列点名条（含**错因/改正**）。细则 → [lessons-learned.md](../references/lessons-learned.md) §错题大纲。
