...
> 日志：`.cursor/pipeline-outcome.log`（gitignore）· 模板 [pipeline-outcome-log.md](../templates/pipeline-outcome-log.md)
...
半页可复制模板 → [TEAM-GUIDE.md](../TEAM-GUIDE.md) §半页备忘 · [window-fulfillment-halfpage.md](../templates/window-fulfillment-halfpage.md)。
...
- sprint 末汇总 **`.cursor/pipeline-recovery-log.md`**（若存在）与 **outcome** 汇总
...
- `.cursor/pipeline-recovery-log.md`（人类可读）— 模板 [pipeline-recovery-log.md](../templates/pipeline-recovery-log.md)
- `.cursor/pipeline-snapshot.log`（JSONL 全量 PM 轨迹）— 模板 [pipeline-snapshot-log.md](../templates/pipeline-snapshot-log.md)
