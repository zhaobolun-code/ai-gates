...
[Getting started](./USER-GUIDE.md) · [Why this design](./METHODOLOGY.md) · [Changelog](./CHANGELOG.md)

## Platform

Supports Cursor / Codex / Trae / Claude Code. Platform issues: see [USER-GUIDE](./USER-GUIDE.md).
