# init-project-context.ps1 — 新项目初始化 project-context（v3.2.1）
...
$yamlTarget = Join-Path $repoRoot ".ai-gates/regression-index.yaml"
$recoveryLogTemplate = Join-Path $repoRoot ".cursor/skills/templates/pipeline-recovery-log.md"
$recoveryLogTarget = Join-Path $repoRoot ".ai-gates/pipeline-recovery-log.md"
$snapshotLogTemplate = Join-Path $repoRoot ".cursor/skills/templates/pipeline-snapshot-log.md"
$snapshotLogTarget = Join-Path $repoRoot ".ai-gates/pipeline-snapshot.log"
